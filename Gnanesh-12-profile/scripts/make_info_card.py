...
# ===========================================================================
HOST = "gnanesh"   # shown as  gnanesh@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Final-yr B.Tech CSE @ Amrita"),
    ("kv", "Prev", "AI & Data Ops Intern @ BuzzBrain"),
    ("kv", "Also", "Federated Learning capstone (AQI)"),
    ("kv", "Edu", "B.Tech CSE, Amrita '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, Java, C++"),
    ("kv", "AI / ML", "TensorFlow, Flower, scikit-learn"),
    ("kv", "Backend", "Flask, FastAPI, MongoDB"),
    ("kv", "Cloud/Edge", "Docker, React, Edge-Fog-Cloud"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Head detection/counting: YOLOv8n -> CSRNet"),
    ("bul", "Federated AQI forecasting, edge-fog-cloud arch"),
]
